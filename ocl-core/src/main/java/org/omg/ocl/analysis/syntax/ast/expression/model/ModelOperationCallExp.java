 ...
 */
public class ModelOperationCallExp extends OperationCallExp {

    public ModelOperationCallExp(Position position, OCLExpression source, String name, List<OCLExpression> arguments) {
        super(position, source, name, arguments);
    }
