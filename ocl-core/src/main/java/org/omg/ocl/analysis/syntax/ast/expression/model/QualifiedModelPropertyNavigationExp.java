 ...
 */
public class QualifiedModelPropertyNavigationExp extends NavigationExp {
    private List<OCLExpression> qualifiers = new ArrayList<>();

    public QualifiedModelPropertyNavigationExp(Position position, OCLExpression source, String name, List<OCLExpression> qualifiers) {
        super(position, source, name);
        if (qualifiers != null) {
