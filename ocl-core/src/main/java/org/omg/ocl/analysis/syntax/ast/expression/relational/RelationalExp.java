/*
 ...
 under the License.
*/
package org.omg.ocl.analysis.syntax.ast.expression.relational;
 ...
 */
public abstract class RelationalExp extends OCLExpression {
    private final OCLExpression leftOperand;
    private final OCLExpression rightOperand;

    public RelationalExp(Position position, OCLExpression leftOperand, OCLExpression rightOperand) {
        super(position);
