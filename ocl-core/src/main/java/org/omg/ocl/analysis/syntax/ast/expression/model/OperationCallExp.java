 ...
 */
public abstract class OperationCallExp extends ModelExp {
    private final String name;
    private List<OCLExpression> arguments = new ArrayList<>();

    public OperationCallExp(Position position, OCLExpression source, String name, List<OCLExpression> arguments) {
