 ...
 */
public class OCLLetExpression extends OCLExpression {
    public OCLLetExpression(Position position, List<VariableDeclaration> variableDeclarations, OCLExpression body) {
        super(position);
    }
