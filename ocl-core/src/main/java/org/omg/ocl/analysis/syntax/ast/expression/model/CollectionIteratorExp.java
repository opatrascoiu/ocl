 ...
 */
public class CollectionIteratorExp extends LoopExp {

    public CollectionIteratorExp(Position position, OCLExpression source, String name, VariableDeclaration iterator1, VariableDeclaration iterator2, OCLExpression body) {
