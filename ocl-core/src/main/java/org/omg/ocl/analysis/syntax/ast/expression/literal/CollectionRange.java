...
public class CollectionRange extends CollectionLiteralPart {
    private final OCLExpression first;
    private final OCLExpression last;

    public CollectionRange(Position position, OCLExpression first, OCLExpression last) {
        super(position);
        this.first = first;
        this.last = last;
    }
    ...
    public String toString() {
        return String.format("%s(%s..%s)", getClass().getSimpleName(), first, last);
    }
}
